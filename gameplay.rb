def gameplay
    ...
    iteration = 7
    questions = [
    ["How many Big Macs can you buy with 1 bitcoin?".center(175)     , 5.5,"images/big_mac.jpg"],
    ["How many 2004 Holden Commodores can you buy with 1 bitcoin?".center(175)     , 4500,"images/commodore.jpg"],
    ["How many pets goats could you buy with 1 bitcoin?".center(175)     , 180, "images/new_goat.jpg"],
    ["How many packets of Tim Tams could you buy with 1 bitcoin".center(175)     , 3.65, "images/timtam.jpg"],
    ["How many Nintendo Switches can you buy with 1 bitcoin".center(175)     , 399, "images/switch_prop.jpg" ]
    ]
